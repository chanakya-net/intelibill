...
internal sealed class OfflineSaleVarianceAnalyzer(IReconciliationIssueRepository reconciliationIssueRepository)
{
        ...
        List<ReconciliationIssue> issues)
    {
        ...
        var printedName = OfflineSaleSyncHelpers.NormalizeOptional(sale.CustomerName);
        var printedPhone = OfflineSaleSyncHelpers.NormalizeOptional(sale.CustomerPhone);
