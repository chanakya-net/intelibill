using InventoryAI.Api.Extensions;
using InventoryAI.Api.Options;
using InventoryAI.Application.Features.Auth.Commands.ExternalLogin;
using InventoryAI.Application.Features.Auth.Commands.LoginWithEmail;
using InventoryAI.Application.Features.Auth.Commands.RefreshToken;
using InventoryAI.Application.Features.Auth.Commands.RegisterWithEmail;
using InventoryAI.Application.Features.Auth.Commands.RegisterWithPhone;
using InventoryAI.Application.Features.Auth.Commands.RequestPasswordReset;
