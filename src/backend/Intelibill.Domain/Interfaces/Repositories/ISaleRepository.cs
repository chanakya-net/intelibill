...
public interface ISaleRepository : IRepository<Sale>
{
    ...
    Task<IReadOnlyList<Sale>> GetByIdsAsync(Guid shopId, IReadOnlyCollection<Guid> saleIds, CancellationToken cancellationToken = default);
...
public sealed record DashboardLatestSaleReadModel(
    Guid SaleId,
    string InvoiceNumber,
