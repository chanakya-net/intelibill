...
namespace Intelibill.Infrastructure.Migrations
{
    ...
    [Migration("20260403180737_AddInventoryFoundation")]
            ...
            modelBuilder.Entity("Intelibill.Domain.Entities.Item", b =>
                {
                    ...
                    b.HasIndex("PreferredSupplierId")
                        .HasDatabaseName("ix_items_preferred_supplier_id");
            ...
            modelBuilder.Entity("Intelibill.Domain.Entities.Item", b =>
                {
                    b.HasOne("Intelibill.Domain.Entities.Supplier", null)
                        ...
                        .HasConstraintName("fk_items_suppliers_preferred_supplier_id");
