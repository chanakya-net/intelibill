...
/// Create a copy of UpdateShopRequestDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpdateShopRequestDtoCopyWith<UpdateShopRequestDto> get copyWith => _$UpdateShopRequestDtoCopyWithImpl<UpdateShopRequestDto>(this as UpdateShopRequestDto, _$identity);

  /// Serializes this UpdateShopRequestDto to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateShopRequestDto&&(identical(other.name, name) || other.name == name)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.pincode, pincode) || other.pincode == pincode)&&(identical(other.contactPerson, contactPerson) || other.contactPerson == contactPerson)&&(identical(other.mobileNumber, mobileNumber) || other.mobileNumber == mobileNumber)&&(identical(other.gstNumber, gstNumber) || other.gstNumber == gstNumber));
}
...
@override
String toString() {
  return 'UpdateShopRequestDto(name: $name, address: $address, city: $city, state: $state, pincode: $pincode, contactPerson: $contactPerson, mobileNumber: $mobileNumber, gstNumber: $gstNumber)';
}
...
/// @nodoc
abstract mixin class $UpdateShopRequestDtoCopyWith<$Res>  {
  factory $UpdateShopRequestDtoCopyWith(UpdateShopRequestDto value, $Res Function(UpdateShopRequestDto) _then) = _$UpdateShopRequestDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UpdateShopRequestDtoCopyWithImpl<$Res>
    implements $UpdateShopRequestDtoCopyWith<$Res> {
  _$UpdateShopRequestDtoCopyWithImpl(this._self, this._then);

  final UpdateShopRequestDto _self;
  final $Res Function(UpdateShopRequestDto) _then;
...
/// Adds pattern-matching-related methods to [UpdateShopRequestDto].
extension UpdateShopRequestDtoPatterns on UpdateShopRequestDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdateShopRequestDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpdateShopRequestDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdateShopRequestDto value)  $default,){
final _that = this;
switch (_that) {
case _UpdateShopRequestDto():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdateShopRequestDto value)?  $default,){
final _that = this;
switch (_that) {
case _UpdateShopRequestDto() when $default != null:
return $default(_that);case _:
...
class _UpdateShopRequestDto implements UpdateShopRequestDto {
  const _UpdateShopRequestDto({@JsonKey(name: 'name') required this.name, @JsonKey(name: 'address') required this.address, @JsonKey(name: 'city') required this.city, @JsonKey(name: 'state') required this.state, @JsonKey(name: 'pincode') required this.pincode, @JsonKey(name: 'contactPerson') this.contactPerson, @JsonKey(name: 'mobileNumber') this.mobileNumber, @JsonKey(name: 'gstNumber') this.gstNumber});
  factory _UpdateShopRequestDto.fromJson(Map<String, dynamic> json) => _$UpdateShopRequestDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$UpdateShopRequestDtoCopyWith<_UpdateShopRequestDto> get copyWith => __$UpdateShopRequestDtoCopyWithImpl<_UpdateShopRequestDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UpdateShopRequestDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateShopRequestDto&&(identical(other.name, name) || other.name == name)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.pincode, pincode) || other.pincode == pincode)&&(identical(other.contactPerson, contactPerson) || other.contactPerson == contactPerson)&&(identical(other.mobileNumber, mobileNumber) || other.mobileNumber == mobileNumber)&&(identical(other.gstNumber, gstNumber) || other.gstNumber == gstNumber));
}
...
/// @nodoc
abstract mixin class _$UpdateShopRequestDtoCopyWith<$Res> implements $UpdateShopRequestDtoCopyWith<$Res> {
  factory _$UpdateShopRequestDtoCopyWith(_UpdateShopRequestDto value, $Res Function(_UpdateShopRequestDto) _then) = __$UpdateShopRequestDtoCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'name') String name,@JsonKey(name: 'address') String address,@JsonKey(name: 'city') String city,@JsonKey(name: 'state') String state,@JsonKey(name: 'pincode') String pincode,@JsonKey(name: 'contactPerson') String? contactPerson,@JsonKey(name: 'mobileNumber') String? mobileNumber,@JsonKey(name: 'gstNumber') String? gstNumber
});
...
/// @nodoc
class __$UpdateShopRequestDtoCopyWithImpl<$Res>
    implements _$UpdateShopRequestDtoCopyWith<$Res> {
  __$UpdateShopRequestDtoCopyWithImpl(this._self, this._then);

  final _UpdateShopRequestDto _self;
  final $Res Function(_UpdateShopRequestDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? address = null,Object? city = null,Object? state = null,Object? pincode = null,Object? contactPerson = freezed,Object? mobileNumber = freezed,Object? gstNumber = freezed,}) {
  return _then(_UpdateShopRequestDto(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,address: null == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as String,city: null == city ? _self.city : city // ignore: cast_nullable_to_non_nullable
as String,state: null == state ? _self.state : state // ignore: cast_nullable_to_non_nullable
