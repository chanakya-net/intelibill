...
class AddInventoryPage extends ConsumerStatefulWidget {
  ...
  static const manufacturingDateFieldKey =
      Key('add-inventory-manufacturing-date');
...
class _AddInventoryPageState extends ConsumerState<AddInventoryPage> {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) => _validateRequired(
                    value,
                    requiredMessage: l10n.inventoryInboundItemNameRequired,
                ...
                TextFormField(
                  ...
                  validator: (value) => _validateRequired(
                    value,
                    requiredMessage: l10n.inventoryInboundBarcodeRequired,
  ...
  void _submit() {
    ...
    unawaited(
      ref.read(addInventoryControllerProvider.notifier).submitInbound(
