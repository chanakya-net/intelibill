...
public class RecordSaleCommandHandlerTests
{
    ...
    public RecordSaleCommandHandlerTests()
    {
        ...
        _serviceProvider.GetService(typeof(SaleDtoBuilder)).Returns(_saleDtoBuilder);
    ...
    private RecordSaleCommandHandler CreateHandler() =>
        new(_saleLineValidator, _salePricingCalculator, _customerResolver, _saleRepository, _serviceProvider, _customerLedgerEntryRepository, _stockTransactionRepository, _unitOfWork);
